...
class Config(BaseSettings):
    ...
    static_url_path: str = Field("/static", description="URL path for serving static files", init=False)
    ...
    def db_path(self) -> Path:
        ...
        Returns the path to the SQLite database file named 'passwords.sqlite',
        located in the parent directory of BASE_DIR.

        Returns:
            Path: The full path to the 'passwords.sqlite' database file.
