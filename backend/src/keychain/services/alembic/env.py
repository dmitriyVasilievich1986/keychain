...
from keychain.services.db_client import DBClient, models
from keychain.services.db_client.models.base import mapper_registry
...
db_client = DBClient(app_config=app_config)
